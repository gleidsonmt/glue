...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "io.github.gleidsonmt.core/io.github.gleidsonmt.core.App"
...
@rem Execute core
"%JAVA_EXE%" %JAVA_OPTS% %CORE_OPTS% %DEFAULT_JVM_OPTS% %*
